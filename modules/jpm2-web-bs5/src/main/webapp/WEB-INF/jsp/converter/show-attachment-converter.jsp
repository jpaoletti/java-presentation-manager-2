...
<c:if test="${not empty param.len}">
    ...
    <span data-downloadable="${param.downloadable}" data-type="${param.contentType}" data-id="${param.noteId}" data-entity="${param.entity}" class="viewAttachmentIco"><i class="fas fa-search"></i>&nbsp;${param.attachmentName} (${param.len})</span>
</c:if>
