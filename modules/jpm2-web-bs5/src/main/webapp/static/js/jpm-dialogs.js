function jpmDialogConfirm(params) {
    ...
    wrapper.innerHTML = '<div class="modal-dialog ' + params.addClass + '" id="jpm-dialog-confirm"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">' + (params.title || messages["jpm.modal.confirm.title"]) + '</h5>'
