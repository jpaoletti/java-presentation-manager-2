...
<security:authorize access="hasAnyRole('${param.weakAuth}', 'SPECIAL')">
    <c:if test="${param.showBtn}">
        <a id="weak${field}" class="btn btn-info btn-sm" href="${cp}jpm/${contextualEntity}/${param.ownerId}/${param.weakId}${param.context}/list"><span class="${param.btnIcon}"></span>&nbsp;<spring:message code='${param.btnText}' text='Change' /></a><br/>
    </c:if>
