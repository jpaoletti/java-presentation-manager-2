<nav aria-label="breadcrumb" id="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="${cp}${currentHome}" title="" class="tip-bottom"><span class="fas fa-home"></span> <span class="d-none d-md-inline"><spring:message code="jpm.index.home" text="Home" /></span></a>
        </li>
        ...
        <c:if test="${operation.id ne 'list' and entity.containingListOperation}">
            ...
            <c:if test="${not empty owner}">
                ...
                <a href="${cp}jpm/${owner.id}${entityContext}/${ownerId}/${contextualEntity}/list">
                    <span class="fas fa-th-list"></span> <span class="d-none d-md-inline"><spring:message code="jpm.operation.list" text="List" arguments="${entity.title}" /></span>
                </a>
            </c:if>
