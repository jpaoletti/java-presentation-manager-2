<c:if test="${entity.paginable}">
    <div class="inline-block float-left">
        <c:if test="${not entity.countable}">
            <form action="" class="form-inline d-flex flex-nowrap float-left" role="form">
        ...
        <div class="pagination pagination-sm btn-group">
            <a href="?page=${paginatedList.page-1}" class="btn btn-sm btn-outline-secondary ${(paginatedList.page > 1)?'':"disabled"}">&laquo; </a>
            ...
            <a href="?page=${paginatedList.page+1}" class="btn btn-sm btn-outline-secondary ${paginatedList.more?'':"disabled"}">&raquo;</a>
        </div>
    </div>
