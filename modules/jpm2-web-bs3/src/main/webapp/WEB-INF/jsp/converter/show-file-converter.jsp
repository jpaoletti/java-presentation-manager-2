    ...
    <div class="input-group">
        ...
        <c:if test="${param.downloadable}">
            <div class="input-group-addon">
                <a href="${cp}jpm/${entity.id}/${param.instanceId}/download/${field}?contentType=${param.contentType}&prefix=${param.prefix}&sufix=${param.sufix}"><span class="glyphicon glyphicon-download"></span></a>
            </div>
        </c:if>
    </div>
</c:if>
