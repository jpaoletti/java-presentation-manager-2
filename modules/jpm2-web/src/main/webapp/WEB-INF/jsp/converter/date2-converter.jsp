...
<script type="text/javascript" src="${cp}static/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="${cp}static/js/locale/bootstrap-datepicker.${pageContext.response.locale}.js"></script>
