...
<c:if test="${param.showBtn}">
    <a id="weak${field}" class="btn btn-default btn-xs" href="${cp}jpm/${entity.id}/${param.ownerId}/${param.weakId}/list"><i class="glyphicon ${param.btnIcon}"></i>&nbsp;<spring:message code='${param.btnText}' text='Change' /></a><br/>
</c:if>
