...
function _MakePWDWidget() {
    ...
    code += "<input autocomplete='off' type='password' class='pwdfield form-control' name='" + pwdname + "' id='" + this.pwdfieldid + "'>";
    this.pwdtxtfield = pwdname + "_text";
    this.pwdtxtfieldid = this.pwdtxtfield + "_id";
    code += "<input autocomplete='off' type='text' class='pwdfield form-control' name='" + this.pwdtxtfield + "' id='" + this.pwdtxtfieldid + "' style='display: none;'>";
